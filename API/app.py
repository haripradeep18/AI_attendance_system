...
def DATABASE_CONNECTION():
    return mysql.connector.connect(
        ...
        #
        # mysql.connector.connect(user=DATABASE_USER,
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            user_saw_today_sql_query =\
                f"SELECT (1) FROM users WHERE date = '{json_data['date']}' AND name = '{json_data['name']}'"
...
def add_employee():
    try:
        ...
        file_path = os.path.join(current_path, f"assets/img/users/{request.form['nameOfEmployee']}.jpg")
